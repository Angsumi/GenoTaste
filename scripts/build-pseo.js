...
<body>
  ...
  <nav class="navbar" id="navbar">
    <div class="container nav-container">
      <a href="${relPath}index.html" class="nav-brand">
        <img src="${relPath}Logo_GenoTaste.png" alt="GenoTaste Logo" class="brand-logo-img">
        <span class="brand-name">GenoTaste</span>
      </a>
      <ul class="nav-links">
        <li><a href="${relPath}index.html#process">Our Process</a></li>
        <li><a href="${relPath}genes/index.html">Gene Directory</a></li>
        <li><a href="${relPath}traits/index.html">Wellness Traits</a></li>
        <li><a href="${relPath}diets/index.html">Diet Matcher</a></li>
        <li><a href="${relPath}tools/index.html" class="nav-cta-highlight">Interactive Tools</a></li>
        <li><a href="${relPath}index.html#packages" class="btn btn-primary btn-nav">Book Consultation</a></li>
      </ul>
